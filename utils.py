...
def sample_prompt_generator(kml_path='samples.kml', n_samples=3):
    prompt = 'Here are some samples of the flight plans for a particular hazardous area: \n'
...
def convert_coordinates_to_airspace_auto(
    ...
    origin_names = ['Walmart', 'SweetGreen', 'GNC', 'Mendocino']
    ...
    if origin_key is None:
        origin_key = next((k for k in coordinates if k in origin_names), None)
